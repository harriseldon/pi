...
@XmlType(name = "AuditLogEntryData", namespace = "urn:com.sap.aii.mdt.api.data", propOrder = {
    "timeStamp",
    "textKey",
    "params",
    "status",
...
public class AuditLogEntryData {
    ...
    @XmlElementRef(name = "timeStamp", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> timeStamp;
    @XmlElementRef(name = "textKey", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textKey;
    @XmlElementRef(name = "params", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfString> params;
    @XmlElementRef(name = "status", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
    protected JAXBElement<String> status;
    @XmlElementRef(name = "localizedText", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
