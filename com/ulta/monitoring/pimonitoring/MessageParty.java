...
@XmlType(name = "MessageParty", namespace = "urn:com.sap.aii.mdt.api.data", propOrder = {
    "agency",
    "name",
    "schema"
})
    ...
    extends AttributeValue
{
    ...
    @XmlElementRef(name = "agency", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
    protected JAXBElement<String> agency;
    @XmlElementRef(name = "name", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
    protected JAXBElement<String> name;
    @XmlElementRef(name = "schema", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
