...
@XmlType(name = "WSMessageFilterExt", namespace = "urn:com.sap.aii.mdt.api.data.esiext", propOrder = {
    "applicationComponent",
    "serviceDefinition",
    "softwareComponent"
})
@XmlSeeAlso({
    WSMessageFilterExtImpl.class
})
public class WSMessageFilterExt
    extends MessageFilterExt
{

    @XmlElementRef(name = "applicationComponent", namespace = "urn:com.sap.aii.mdt.api.data.esiext", type = JAXBElement.class, required = false)
    protected JAXBElement<String> applicationComponent;
    @XmlElementRef(name = "serviceDefinition", namespace = "urn:com.sap.aii.mdt.api.data.esiext", type = JAXBElement.class, required = false)
    protected JAXBElement<String> serviceDefinition;
    @XmlElementRef(name = "softwareComponent", namespace = "urn:com.sap.aii.mdt.api.data.esiext", type = JAXBElement.class, required = false)
