...
@XmlType(name = "MessagingSystemFilter", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", propOrder = {
    "archive",
    "connectionName",
    "correlationID",
    "dateType",
...
public class MessagingSystemFilter {
    ...
    @XmlElementRef(name = "correlationID", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "fromTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "messageFormat", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", type = JAXBElement.class, required = false)
    protected JAXBElement<String> messageFormat;
    @XmlElementRef(name = "messageIDs", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "referenceIDs", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "sequenceID", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "statuses", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfString> statuses;
    protected int timesFailed;
    @XmlElementRef(name = "toTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws.esiext", type = JAXBElement.class, required = false)
