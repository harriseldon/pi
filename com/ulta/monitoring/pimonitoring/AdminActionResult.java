...
/**
 * <p>Java class for AdminActionResult complex type.
 * 
...
@XmlType(name = "AdminActionResult", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", propOrder = {
    "resultCode",
    "resultText",
    "successful"
})
public class AdminActionResult {
    ...
    @XmlElementRef(name = "resultCode", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> resultCode;
    @XmlElementRef(name = "resultText", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
