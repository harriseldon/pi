...
@XmlType(name = "MessageSearchReturnValue", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", propOrder = {
    "date",
    "list",
    "number",
    "warning",
...
public class MessageSearchReturnValue {
    ...
    @XmlElementRef(name = "date", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> date;
    @XmlElementRef(name = "list", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
