...
/**
 * <p>Java class for AdapterFrameworkData complex type.
 * 
...
@XmlType(name = "AdapterFrameworkData", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", propOrder = {
...
public class AdapterFrameworkData {

    @XmlElementRef(name = "applicationComponent", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> applicationComponent;
    @XmlElementRef(name = "businessMessage", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<BooleanAttribute> businessMessage;
    @XmlElementRef(name = "cancelable", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<BooleanAttribute> cancelable;
    @XmlElementRef(name = "connectionName", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> connectionName;
    @XmlElementRef(name = "credential", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> credential;
    @XmlElementRef(name = "direction", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> direction;
    @XmlElementRef(name = "editable", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<BooleanAttribute> editable;
    @XmlElementRef(name = "endTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> endTime;
    @XmlElementRef(name = "endpoint", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> endpoint;
    @XmlElementRef(name = "errorCategory", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> errorCategory;
    @XmlElementRef(name = "errorCode", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> errorCode;
    @XmlElementRef(name = "headers", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> headers;
    @XmlElementRef(name = "interface", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<MessageInterface> _interface;
    protected boolean isPersistent;
    @XmlElementRef(name = "messageID", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> messageID;
    @XmlElementRef(name = "messageKey", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> messageKey;
    @XmlElementRef(name = "messageType", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> messageType;
    protected int nodeId;
    @XmlElementRef(name = "persistUntil", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> persistUntil;
    @XmlElementRef(name = "protocol", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> protocol;
    @XmlElementRef(name = "qualityOfService", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> qualityOfService;
    @XmlElementRef(name = "receiverInterface", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<MessageInterface> receiverInterface;
    @XmlElementRef(name = "receiverName", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> receiverName;
    @XmlElementRef(name = "receiverParty", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<MessageParty> receiverParty;
    @XmlElementRef(name = "referenceID", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> referenceID;
    @XmlElementRef(name = "restartable", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<BooleanAttribute> restartable;
    protected int retries;
    protected long retryInterval;
    @XmlElementRef(name = "scheduleTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> scheduleTime;
    @XmlElementRef(name = "senderInterface", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<MessageInterface> senderInterface;
    @XmlElementRef(name = "senderName", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> senderName;
    @XmlElementRef(name = "senderParty", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<MessageParty> senderParty;
    @XmlElementRef(name = "sequenceNumber", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> sequenceNumber;
    @XmlElementRef(name = "serializationContext", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> serializationContext;
    @XmlElementRef(name = "serviceDefinition", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> serviceDefinition;
    @XmlElementRef(name = "softwareComponent", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> softwareComponent;
    @XmlElementRef(name = "startTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> startTime;
    @XmlElementRef(name = "status", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> status;
    protected long timesFailed;
    @XmlElementRef(name = "transport", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> transport;
    @XmlElementRef(name = "validUntil", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> validUntil;
    @XmlElementRef(name = "version", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> version;
    @XmlElementRef(name = "wasEdited", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<BooleanAttribute> wasEdited;
    @XmlElementRef(name = "businessAttributes", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfBusinessAttribute> businessAttributes;
    @XmlElementRef(name = "payloadPermissionWarning", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<BooleanAttribute> payloadPermissionWarning;
    protected int errorLabel;
    @XmlElementRef(name = "scenarioIdentifier", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    ...
    public void setApplicationComponent(JAXBElement<String> value) {
        this.applicationComponent = value;
    }
     ...
     *     
     */
    public JAXBElement<BooleanAttribute> getBusinessMessage() {
     ...
     *     
     */
    public void setBusinessMessage(JAXBElement<BooleanAttribute> value) {
    ...
    /**
     * Gets the value of the businessAttributes property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfBusinessAttribute }{@code >}
     *     
     */
    public JAXBElement<ArrayOfBusinessAttribute> getBusinessAttributes() {
        return businessAttributes;
    }

    /**
     * Sets the value of the businessAttributes property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfBusinessAttribute }{@code >}
     *     
     */
    public void setBusinessAttributes(JAXBElement<ArrayOfBusinessAttribute> value) {
        this.businessAttributes = value;
    }

    /**
     * Gets the value of the payloadPermissionWarning property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link BooleanAttribute }{@code >}
     *     
     */
    public JAXBElement<BooleanAttribute> getPayloadPermissionWarning() {
        return payloadPermissionWarning;
    }

    /**
     * Sets the value of the payloadPermissionWarning property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BooleanAttribute }{@code >}
     *     
     */
    public void setPayloadPermissionWarning(JAXBElement<BooleanAttribute> value) {
        this.payloadPermissionWarning = value;
    }
     ...
     * 
     */
    public void setErrorLabel(int value) {
        this.errorLabel = value;
    }

    /**
     * Gets the value of the scenarioIdentifier property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    /**
     * Sets the value of the scenarioIdentifier property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
