...
/**
 * <p>Java class for AdapterFilter complex type.
 * 
...
@XmlType(name = "AdapterFilter", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", propOrder = {
...
public class AdapterFilter {
    ...
    @XmlElementRef(name = "correlationID", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "fromTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "messageFormat", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> messageFormat;
    @XmlElementRef(name = "messageIDs", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "referenceIDs", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "sequenceID", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "statuses", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfString> statuses;
    protected int timesFailed;
    @XmlElementRef(name = "toTime", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
