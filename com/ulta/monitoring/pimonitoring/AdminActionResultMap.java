...
@XmlType(name = "AdminActionResultMap", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", propOrder = {
    "keyList",
    "resultList"
})
public class AdminActionResultMap {

    @XmlElementRef(name = "keyList", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfString> keyList;
    @XmlElementRef(name = "resultList", namespace = "urn:com.sap.aii.mdt.server.adapterframework.ws", type = JAXBElement.class, required = false)
