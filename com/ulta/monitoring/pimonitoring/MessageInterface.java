...
@XmlType(name = "MessageInterface", namespace = "urn:com.sap.aii.mdt.api.data", propOrder = {
    "name",
    "namespace"
})
    ...
    extends AttributeValue
{
    ...
    @XmlElementRef(name = "namespace", namespace = "urn:com.sap.aii.mdt.api.data", type = JAXBElement.class, required = false)
